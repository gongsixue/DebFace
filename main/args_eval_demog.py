...
train = 'face_cls'
save_results = False
result_path = '/research/prip-gongsixu/codes/biasface/results/models/face_demog_3'
extract_feat = False
just_test = False
feat_savepath = '/scratch/gongsixue/face_resolution/feats/feat_cfp_aligned_112x112.npz'
# resume = None
...
resume = '/research/prip-gongsixu/codes/biasface/results/models/face_demog_3/Save'
# ======================== Main Setings ====================================
...
dataset_test = 'DemogCSVListLoader'
# dataset_test = 'AgeBinaryLoader'
# dataset_test = 'FileListLoader'
input_filename_test = '/research/prip-gongsixu/codes/biasface/datasets/list_face_demog_groups.csv'
...
model_options = [{"nclasses": nclasses}, {"in_dims":4*512, "out_dims":2}]
